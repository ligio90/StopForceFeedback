...
public class LogitechGSDK
{
    ...
    [DllImport("L:\\AntiFFB\\AntiFFB\\AntiFFB\\LogitechSteeringWheelEnginesWrapper.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool LogiSteeringInitialize(bool ignoreXInputControllers);

    [DllImport("L:\\AntiFFB\\AntiFFB\\AntiFFB\\LogitechSteeringWheelEnginesWrapper.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool LogiUpdate();

    [DllImport("L:\\AntiFFB\\AntiFFB\\AntiFFB\\LogitechSteeringWheelEnginesWrapper.dll", CallingConvention = CallingConvention.Cdecl)]
